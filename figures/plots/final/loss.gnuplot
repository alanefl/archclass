...
set output "figures/plots/final/loss.ps"
...
plot "figures/data/final/final_train.csv" using 1:3 with linespoints ls 3 title "Train", \
  "figures/data/final/final_train.csv" using 1:5 with linespoints ls 4 title "Dev"
